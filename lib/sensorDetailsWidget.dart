...
class SensorDetailsWidget extends StatefulWidget {
  ...
  SensorDetailsWidget({Key? key, required this.sensorId}) : super(key: key);

  @override
  _SensorDetailsWidgetState createState() => _SensorDetailsWidgetState();
}
...
class _SensorDetailsWidgetState extends State<SensorDetailsWidget> {
  ...
  @override
  void didUpdateWidget(SensorDetailsWidget oldWidget) {
  ...
  Future<List<dynamic>> fetchData() async {
    var url =
        Uri.parse('https://civic-aq-dashboard.com/api/data_${widget.sensorId}');
